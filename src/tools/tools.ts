...
// 取得民國年日期格式 yyyy / mm / dd 或 民國年月日
export function transferToROCDate(dateString: string, isSimplified: boolean = false) {
  ...
  return isSimplified ?
    `${date.getFullYear() - 1911} / ${month} / ${dayofMonth}` :
    `民國 ${date.getFullYear() - 1911} 年 ${month} 月 ${dayofMonth} 日`;
}
...
// 取得民國年月格式 yyyy / mm 或 民國年月
export function transferToROCYearMonth(dateString: string, isSimplified: boolean = false) {
  ...
  return isSimplified ?
    `${date.getFullYear() - 1911} / ${month}` : `民國 ${date.getFullYear() - 1911} 年 ${month} 月`;
}



// 取得民國年日期格式 yyyy / mm / dd hh:mm:ss 或 民國年月日時分秒
export function transferToROCDateWithtimes(dateString: string, isSimplified: boolean = false) {
  ...
  return isSimplified ?
    `${date.getFullYear() - 1911} / ${month} / ${dayofMonth} ${hours}:${minutes}:${seconds}` :
    `民國 ${date.getFullYear() - 1911} 年 ${month} 月 ${dayofMonth} 日 ${hours} 時 ${minutes} 分 ${seconds} 秒`;
}
